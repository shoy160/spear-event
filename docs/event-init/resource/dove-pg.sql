...
-- ----------------------------
ALTER TABLE "public"."client" ADD CONSTRAINT "application_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table client_grant
-- ----------------------------
ALTER TABLE "public"."client_grant" ADD CONSTRAINT "client_grant_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
-- Primary Key structure for table event_data
-- ----------------------------
ALTER TABLE "public"."event_data" ADD CONSTRAINT "event_data_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "public"."event_schema"
    ADD CONSTRAINT "event_schema_pkey" PRIMARY KEY ("id");
