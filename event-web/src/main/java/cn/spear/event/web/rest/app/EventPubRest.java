...
public class EventPubRest extends BaseAppRest {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "ce-subject", value = "事件编码", paramType = "header", example = "user.created", required = true, dataTypeClass = String.class),
            ...
            @ApiImplicitParam(name = "ce-source", value = "事件来源", paramType = "header", example = "/user/created", required = true, dataTypeClass = String.class),
